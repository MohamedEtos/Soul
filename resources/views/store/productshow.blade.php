...
@section('head')
    <style>
        .avatar-initials {
            ...
            font-size: 14px;
            margin-left: 10px;
            /* Space between avatar and name in RTL */
        }
            ...
            <div class="row   ">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->mainImage) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="{{ asset($product->product_img_p->mainImage) }}"
                                            alt="{{ $product->name }}">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ asset($product->product_img_p->mainImage) }}">
                                ...
                                <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->img2) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ asset($product->product_img_p->img2) }}">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->img3) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ asset($product->product_img_p->img3) }}">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->img4) }}">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="{{ asset($product->product_img_p->img4) }}">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                @if($product->product_img_p->img5)
                                    <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->img5) }}">
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset($product->product_img_p->img5) }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                @if($product->product_img_p->img6)
                                    <div class="item-slick3" data-thumb="{{ asset($product->product_img_p->img6) }}">
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset($product->product_img_p->img6) }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-lg-5 p-b-30" dir="rtl">
                    <div class="p-r-50 p-t-5 p-lr-0-lg h4">
                        {{ $product->name }} <span
                            style="{{ $product->stock > 0 ? 'color:green' : 'color:red' }}">({{ $product->stock > 0 ? 'متوفر' : 'غير متوفر' }})</span>
                        </h1>
                                        ...
                                        @if($product->sizes->count() > 0)
                                            @foreach($product->sizes as $size)
                                                <div class="option-btn size-option {{ $size->stock <= 0 ? 'disabled' : '' }}"
                                                    data-value="{{ $size->size }}" data-stock="{{ $size->stock }}">
                                                    {{ $size->size }}
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="option-btn active"
                                                data-value="{{$product->width}} * {{$product->height}}">
                                                '-'
                                            </div>
                                        @endif
                                        <input type="hidden" name="size" id="selected-size"
                                            value="{{ $product->sizes->count() == 0 ? $product->width . ' * ' . $product->height : '' }}">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="flex-w p-t-4">
                                            @foreach($product->colors as $color)
                                                <div class="color-option {{ $color->stock <= 0 ? 'disabled' : '' }}"
                                                    data-value="{{ $color->color }}" data-stock="{{ $color->stock }}"
                                                    style="background-color: {{ $color->color_code }};" title="{{ $color->color }}">
                                                </div>
                                            @endforeach
                            ...
                            <div class="flex-w  p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                        ...
                                        <input class="mtext-104 cl3 txt-center qty qty_product num-product " type="number"
                                    ...
                                    <button data-product-id="{{ $product->id }}"
                                        class="flex-c-m stext-101 cl0 size-101 bg1 mr-3 bor1  p-lr-15 trans-04 {{ $product->stock > 0 ? 'js-addcart-detail hov-btn1 ' : 'bg2 hov-btn50' }}">
                                        اضف الي السله
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="flex-w flex-m p-l-100 p-t-20 respon7">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}"
                                target="_blank" data-tooltip="facebook" aria-label="Visit our Facebook page"
                                class="fs-35 mr-3 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2  tooltip100">
                                <span class="sr-only">facebook</span>
                                <i class="fa fa-facebook"></i>
                            </a>

                            <a href="https://www.instagram.com/" target="_blank" data-tooltip="instagram"
                            ...
                            <a href="https://wa.me/201090334070" data-tooltip="whatsapp" aria-label="Visit our whatsapp "
                                class="fs-35 mr-3 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2  tooltip100">
            ...
            <div class="bor10 m-t-50 p-t-43 p-b-40">
                ...
                <div class="tab01 " dir="rtl">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item p-b-10">
                            <a class="nav-link" data-toggle="tab" href="#reviews" role="tab">التقيم
                                ({{ $product->approved_reviews_count }})</a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm" id="reviews-list">
                                                        ...
                                                        <div class="flex-w flex-sb-m p-b-17">
                                                            <div class="flex-w flex-m">
                                                                <div class="avatar-initials">
                                                                    ...
                                                                    {{ mb_strtoupper(mb_substr($review->name, 1, 1)) }}
                                                                </div>
                                        ...
                                        <form class="w-full" id="review-form" action="{{ route('review.store') }}"
                                            method="POST">
                                            @csrf
                            ...
                            <a href="{{ route('product.show', $product->slug) }}">
                                ...
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        ...
                                        <img loading="lazy" src="{{ asset($mainImg) }}" @if($isResponsive) srcset="
                                        ...
                                        300px" @endif
                                            alt="{{ $product->product_img_p->alt1 ?? $product->name }}" decoding="async">
                                        ...
                                        <div class="block2-txt-child2 flex-r p-t-3">
                                            <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                                <img class="icon-heart1 dis-block trans-04"
                                                    src="{{ asset('store/images/icons/icon-heart-01.png') }}" alt="ICON">
                                                <img class="icon-heart2 dis-block trans-04 ab-t-l"
                                                    src="{{ asset('store/images/icons/icon-heart-02.png') }}" alt="ICON">
                                            </a>
                                        </div>
                                    </div>
                                </div>
